      ...
      <DashboardLayout title="Analiz Detayı">
        <div className={styles.container}>
          <div className={styles.emptyCard}>
            ...
            <p>Analiz #{id} bilgileri bu oturumda bulunamadı.</p>
    ...
    <DashboardLayout title="Analiz Detayı">
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          <div>
            <div className={styles.breadcrumb}>Analizler / Analiz #{id}</div>

            <h1 className={styles.pageTitle}>Analiz #{id}</h1>
        ...
        <div className={styles.infoGrid}>
          <div className={styles.infoCard}>
            <span className={styles.infoLabel}>Hasta TC Kimlik</span>

            <strong className={styles.infoValue}>{tcKimlik}</strong>
          </div>

          <div className={styles.infoCard}>
            <span className={styles.infoLabel}>İncelenen Organ</span>
          ...
          <div className={styles.infoCard}>
            <span className={styles.infoLabel}>Yapay Zeka Modeli</span>
          ...
          <div className={styles.infoCard}>
            <span className={styles.infoLabel}>Analiz Tarihi</span>

            <strong className={styles.infoValue}>{tarih}</strong>
          </div>
        </div>
        ...
        <div className={styles.sectionCard}>
          <div className={styles.sectionHeader}>
            <div>
              ...
              <p>Orijinal görüntü, AI segmentasyonu ve birleştirilmiş sonuç</p>
            </div>
          </div>
          ...
          <div className={styles.imageGrid}>
            <div className={styles.imageCard}>
              ...
              <div className={styles.imageWrapper}>
                {preview && <img src={preview} alt="Orijinal MR" />}
              </div>
            </div>
            ...
            <div className={styles.imageCard}>
              ...
              <div className={styles.imageWrapper}>
                {processedMask && (
                  <img src={processedMask} alt="AI Segmentasyonu" />
                )}
              </div>
            </div>
            ...
            <div className={styles.imageCard}>
              ...
              <div className={styles.imageWrapper}>
                {overlayImage && (
                  <img src={overlayImage} alt="MR ve AI Örtüşmesi" />
                )}
              </div>
            </div>
          </div>
