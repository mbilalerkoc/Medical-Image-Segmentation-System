      ...
      <div className="relative z-10 w-full max-w-md px-5 py-8">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="relative">
            <div className="absolute inset-0 bg-cyan-400/30 rounded-full blur-2xl scale-90"></div>
            <img src="/logo_pathovision.png" alt="PathoVision Logo" className="relative w-28 h-28 object-contain drop-shadow-[0_0_15px_rgba(34,211,238,0.4)]" />
          </div>
          <h1 className="mt-3 text-4xl font-black tracking-tight text-white drop-shadow-md">
