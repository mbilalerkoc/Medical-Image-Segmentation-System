          ...
          {result && (
            <div className="w-full flex flex-col md:flex-row gap-6 items-center">
              ...
              <div className="w-full md:w-1/2 flex flex-col items-center gap-4">
                 ...
                 {/* Değişken ismi JSON'daki gibi "maske_base64" olarak güncellendi */}
                 {result.maske_base64 && (
                   <div className="relative">
              ...
              <div className="w-full md:w-1/2 space-y-4">
                ...
                <div className="flex justify-between items-center bg-slate-50 p-3 rounded-lg border border-slate-100">
                  ...
                  {/* JSON hiyerarşisi metrikler.patoloji_yuzdesi olarak güncellendi */}
                ...
                <div className="flex justify-between items-center bg-slate-50 p-3 rounded-lg border border-slate-100">
                  ...
                  <span className="text-lg font-bold text-blue-700">{result.metrikler?.dice_skoru?.toFixed(4) || '-'}</span>
                </div>

                <div className="flex justify-between items-center bg-slate-50 p-3 rounded-lg border border-slate-100">
                  <span className="text-slate-600 font-medium">IoU Skoru</span>
                  <span className="text-lg font-bold text-blue-700">{result.metrikler?.iou_skoru?.toFixed(4) || '-'}</span>
                </div>
