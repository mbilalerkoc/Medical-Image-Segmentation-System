...
const NewAnalysis = () => {
  ...
  setResult({ 
    ...response.data.sonuclar, 
    analiz_id: response.data.analiz_id // Rapor kaydederken bu ID'yi kullanacağız
  });
}
    } catch (err) {
  ...
  const handleSaveAndShare = () => {
    // Burada backend'e (reports tablosuna) istek atılacak
    alert(`Rapor kaydedildi ve TC: ${tcKimlik} numaralı hastanın paneline gönderildi!\n\nDoktor Notu: ${doktorNotu}`);
    setIsReportModalOpen(false); // Modalı kapat
  };
