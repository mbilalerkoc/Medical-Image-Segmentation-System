...
const NewAnalysis = () => {
  ...
  const [dragActive, setDragActive] = useState(false); // Sürükle-bırak için

  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState(null);
  const [error, setError] = useState(null);
  
  // Slider State'i (0 ile 100 arası maske görünürlüğü)
          ...
          <div className={styles.modernCard}>
            ...
            <form onSubmit={handleSubmit} className={styles.formBody}>
              ...
              <div className={styles.formGroup}>
                ...
                <div 
                  className={`${styles.dragDropZone} ${dragActive ? styles.dragActive : ''} ${preview ? styles.hasFile : ''}`}
          ...
          <div className={styles.resultCard}>
            ...
            {result && (
              <div className={styles.resultLayout}>
                ...
                {/* YENİ: BEFORE / AFTER SLIDER */}
                {/* YENİ: BEFORE / AFTER SLIDER */}
                <div className={styles.sliderContainer}>
                  {/* Alt Katman: Orijinal MR (Her zaman tam görünür) */}
                  <img src={preview} alt="Orijinal" className={styles.sliderImgBase} />
                  
                  {result.maske_base64 && (
                    <>
                      {/* Üst Katman: clip-path ile sadece kaydırıcının solunda kalan alanı gösteriyoruz */}
                      <div 
                      ...
                      {/* Araya Mavi Kaydırma Çizgisi Eklendi */}
                  ...
                  <div className={styles.sliderLabels}>
                    ...
                    <span className={styles.labelMaske}>AI Segmentasyon</span>
                  </div>
                </div>
