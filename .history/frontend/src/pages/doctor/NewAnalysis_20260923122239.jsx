  ...
  const NewAnalysis = () => {
    ...
    img.onload = () => {
      ...
      for (let i = 0; i < data.length; i += 4) {
        ...
        // Siyah alanları tamamen saydam yap
        if (r < 30 && g < 30 && b < 30) {
          data[i + 3] = 0;
        }
      }
    ...
    baseImage.onload = () => {
      maskImage.onload = () => {
        ...
        // Daha sonra saydamlaştırılmış AI maskesini üzerine çiz
        ctx.drawImage(
          maskImage,
          0,
          0,
        ...
        // Ortaya çıkan görüntüyü PNG olarak kaydet
    ...
    <>
      ...
      >
        <img
          src={processedMask}
          alt="AI Segmentasyon"
          className={styles.sliderImgMask}
        />
      </div>
    ...
    <div>
      ...
      <img
        src={processedMask || `data:image/png;base64,${result?.maske_base64}`}
        alt="AI Segmentasyon Maskesi"
        className="w-full h-48 object-contain bg-black rounded-lg border-2 border-blue-500"
      />
    </div>
    ...
    <div>
      ...
      {overlayImage && (
        <img
          ...
          className="w-full h-48 object-contain bg-black rounded-lg border-2 border-emerald-500"
        />
      )}
    </div>
