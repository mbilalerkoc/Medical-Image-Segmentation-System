...
const NewAnalysis = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwicm9sIjoic3VwZXJhZG1pbiIsImlhdCI6MTc4OTkxODQ5MCwiZXhwIjoxNzkyNTEwNDkwfQ.2xfcnmsW1vkPWuivECn6PPqpJDoB4mrt1t4VibYepJg";
