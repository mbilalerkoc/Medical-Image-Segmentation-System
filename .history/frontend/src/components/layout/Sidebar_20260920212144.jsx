...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-blue-700 text-white flex flex-col shadow-xl h-full">
          ...
          {menuItems.map((item, index) => {
            ...
            return (
              <li 
                ...
                className={`p-3 rounded-lg cursor-pointer transition-colors duration-200 font-medium ${
