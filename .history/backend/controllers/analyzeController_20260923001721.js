...
exports.predictAndSave = async (req, res) => {
    try {
        ...
        // Python'un dosyayı sorunsuz okuyabilmesi için ona temiz bir isim ve tür (mimetype) veriyoruz
        formData.append('dosya', fs.createReadStream(file.path), {
            filename: 'upload_image.jpg', // Sabit ve Türkçe karaktersiz bir isim
