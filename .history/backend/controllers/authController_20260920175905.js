...
// ── YARDIMCI FONKSİYON: Token Üretici ──────────────────────────
const sendTokenResponse = (user, statusCode, res) => {
    // Token'ın içine id ve rolü gömüyoruz ki arayüzde (React) kişinin kim olduğunu bilelim
...
exports.register = async (req, res) => {
    try {
        // Senin SQL tablundaki (users) sütun isimleri:
        const { ad, soyad, email, sifre, tc_kimlik, dogum_tarihi, telefon } = req.body;

        // 1. E-posta adresi sistemde var mı kontrolü (Sequelize formatı)
