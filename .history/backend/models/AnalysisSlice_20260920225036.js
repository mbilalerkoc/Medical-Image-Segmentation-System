...
const AnalysisSlice = sequelize.define('AnalysisSlice', {
    ...
    goruntu_yolu: { type: DataTypes.TEXT), allowNull: false },
    ...
    alan_mm2: { type: DataTypes.FLOAT(10,2) ,defaultValue: 0 },
    cevre_mm: { type: DataTypes.FLOAT(10,2), defaultValue: 0 },
    guven_skoru: { type: DataTypes.FLOAT(5,4),  defaultValue: 0 }
}, {
