...
ORGANLAR = {
    ...
    "2": {
        ...
        "modeller": {
            ...
            "2": {
                "ad"      : "U-NET++ 2. eşik: 0.8 :::: (0.7 * bce) + (0.3 * dice_loss(y_gercek, y_tahmin)) Modeli",
                "model"   : os.path.join(MODEL_KAYIT, 'bobrek_v2.h5'),
                "X_test"  : os.path.join(VERI_KLASORU, 'bobrek_v2_X.npy'),
                "y_test"  : os.path.join(VERI_KLASORU, 'bobrek_v2_Y.npy'),
                "X_npy"   : None,
                "y_npy"   : None,
                "grafik"  : os.path.join(SONUC_KLASOR, 'kidney_v2_egitim_grafikleri.png'),
                "tahmin"  : os.path.join(SONUC_KLASOR, 'kidney_v2_tahmin_sonuclari.png'),
                "txt"     : os.path.join(SONUC_KLASOR, 'kidney_v2_test_metrikleri.txt'),
            },
        }
    }
}
