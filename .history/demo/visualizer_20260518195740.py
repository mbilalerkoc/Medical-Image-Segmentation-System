...
def bolum_veri(X_test, y_test, organ_ad, model_ad, ham_veri_klasoru):
    ...
    # 🎯 Dinamik Terim Ayarı: Organ adına göre kelimeleri belirliyoruz
    # Küçük/büyük harf uyuşmazlığı olmasın diye .lower() ile kontrol ediyoruz
    ...
    # Hesaplamalar (Senin yazdığın mantık aynen korunuyor)
    ...
    # Pozitif vakalardan örnek endeksleri seçme
    ...
    # Grafik Çizimi (Başlıklar ve etiketler dinamik oldu)
