...
ORGANLAR = {
    "1": {
        "ad": "Beyin Tumoru",
        "ham_veri": os.path.join(PROJE_KLASORU, 'dataset', 'brain', 'images'),
        "modeller": {
            "1": {
                "ad"      : "U-NET Modeli",
                "model"   : os.path.join(MODEL_KAYIT ,'beyin_v2.h5'),
                "X_test"  : os.path.join(VERI_KLASORU, 'brain','beyin_v2_X.npy'),
                "y_test"  : os.path.join(VERI_KLASORU,'brain', 'beyin_v2_Y.npy'),
                "X_npy"   : None,
                "y_npy"   : None,
                "grafik"  : os.path.join(SONUC_KLASOR, 'brain','beyin_v2_egitim_grafikleri.png'),
                "tahmin"  : os.path.join(SONUC_KLASOR,'brain', 'beyin_v2_tahmin_sonuclari.png'),
                "txt"     : os.path.join(SONUC_KLASOR,'brain', 'beyin_v2_test_metrikleri.txt'),
            },
            "2": {
                "ad"      : "U-NET++ Modeli",
                "model"   : os.path.join(MODEL_KAYIT, 'beyin_v3.h5'),
                "X_test"  : os.path.join(VERI_KLASORU,'brain', 'beyin_v3_X.npy'),
                "y_test"  : os.path.join(VERI_KLASORU, 'brain','beyin_v3_Y.npy'),
                "X_npy"   : None,
                "y_npy"   : None,
                "grafik"  : os.path.join(SONUC_KLASOR, 'brain','beyin_v3_egitim_grafikleri.png'),
                "tahmin"  : os.path.join(SONUC_KLASOR, 'brain','beyin_v3_tahmin_sonuclari.png'),
                "txt"     : os.path.join(SONUC_KLASOR, 'brain','beyin_v3_test_metrikleri.txt'),
            },
        }
    },
    "2": {
        "ad": "Böbrek taşı",
        "ham_veri": os.path.join(PROJE_KLASORU, 'dataset', 'kidney', 'images'),
        "modeller": {
            "1": {
                "ad"      : "U-NET Modeli",
