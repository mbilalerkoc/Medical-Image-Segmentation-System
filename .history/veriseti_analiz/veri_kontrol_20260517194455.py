...
# Bulunduğumuz dosyanın konumu: veriseti_analiz/veri_kontrol.py
mevcut_dizin = os.path.dirname(os.path.abspath(__file__))

# Sadece BİR üst klasöre (ana projeye) çık, oradan dataset'e gir
proje_ana_dizini = os.path.abspath(os.path.join(mevcut_dizin, ".."))
hedef_klasor = os.path.join(proje_ana_dizini, "dataset", "kidney", "maskeler")
