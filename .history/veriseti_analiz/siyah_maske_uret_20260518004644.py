...
resimlerin_yolu = os.path.join(proje_ana_dizini, "dataset", "saglikli_bobrek_resimleri")
# Siyah maskelerin cikacagi klasor
maskelerin_yolu = os.path.join(proje_ana_dizini, "dataset", "saglikli_bobrek_maskeleri")
